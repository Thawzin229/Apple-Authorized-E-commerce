...
<main class="mdl-layout__content d-flex justify-content-center">
        <div class="mdl-cell mdl-cell--7-col mdl-card__login mdl-shadow--2dp">
          <form class="" action="{{ route('admin#update') }}" method="PUT" enctype="multipart/form-data">
            @csrf
            @method('PUT')
                ...
                <div class="mdl-card__supporting-text color--dark-gray">
                    <div class="mdl-grid">
                        <div class="mdl-cell mdl-cell--12-col mdl-cell--12-col-phone">
                            ...
                            <div class="text-center mt-3"><img class="img-fluid" id="updateproductimage" src="{{ asset('storage/'.$data['image']) }}" alt=""></div>
                        </div>

                        <div class="mdl-cell mdl-cell--12-col mdl-cell--12-col-phone">
                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label full-size">
                                <input value="{{ old('name' , $data['name']) }}" class="mdl-textfield__input" type="text" id="e-mail" name="name">
                            ...
                            <select name="type_id" id=""  class="mdl-textfield__input">
                                ...
                                <option  @if($item['id'] === $data['type_id']) selected @endif   value="{{ $item['id'] }}">{{ $item['name'] }}</option>
                                @endforeach
                              </select>
                            ...
                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label full-size">
                                <input value="{{ old('price',$data['price']) }}" class="mdl-textfield__input" type="text" id="e-mail" name="price">
                        ...
                        <div class="mdl-cell mdl-cell--12-col mdl-cell--4-col-phone submit-cell">
                          ...
                          <button class="mdl-button mdl-cell--12-col mdl-js-button mdl-button--raised color--light-blue">
                              Update
                          </button>
                          </div>
                        </div>
